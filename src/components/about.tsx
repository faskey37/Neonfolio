    ...
    <section id="about" className="py-32 bg-card/40 relative overflow-hidden">
       <div className="absolute inset-0 z-0 opacity-5" style={{backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%239C92AC' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`}}></div>
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <div className="absolute text-primary/10 text-7xl font-mono font-bold top-1/4 left-1/4 animate-float">Ω</div>
          <div className="absolute text-secondary/10 text-6xl font-mono font-bold bottom-1/4 right-1/4 animate-float-alt">ᛟ</div>
          <div className="absolute text-accent/10 text-5xl font-mono font-bold top-1/2 right-1/3 animate-float">ᚦ</div>
           <div className="absolute text-primary/5 text-8xl font-mono font-bold bottom-1/3 left-1/5 animate-float-alt">ᛗ</div>
          <div className="absolute text-secondary/5 text-4xl font-mono font-bold top-1/3 right-1/5 animate-float">ᛞ</div>
        </div>
