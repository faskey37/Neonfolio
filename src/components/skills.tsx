  ...
  return (
    <section id="skills" className="py-24 sm:py-32 bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <div className="absolute text-primary/10 text-7xl font-mono font-bold top-10 left-10 animate-float">ᛒ</div>
          <div className="absolute text-secondary/10 text-6xl font-mono font-bold bottom-10 right-10 animate-float-alt">ᛠ</div>
          <div className="absolute text-accent/10 text-5xl font-mono font-bold top-1/2 right-1/4 animate-float">ᛟ</div>
           <div className="absolute text-primary/5 text-8xl font-mono font-bold bottom-1/4 left-1/5 animate-float-alt">ᛈ</div>
          <div className="absolute text-secondary/5 text-4xl font-mono font-bold top-1/3 right-1/5 animate-float">ᛏ</div>
      </div>
